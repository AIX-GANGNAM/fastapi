...
# 노드 정의 (좌표를 비율로 설정)
nodes = {
    'home_Joy': {'x': 50 / 375, 'y': 600 / 667},
    'home_Anger': {'x': 100 / 375, 'y': 600 / 667},
    'home_Disgust': {'x': 150 / 375, 'y': 600 / 667},
    'home_Sadness': {'x': 200 / 375, 'y': 600 / 667},
    'home_Fear': {'x': 250 / 375, 'y': 600 / 667},
    'park': {'x': 0.1, 'y': 0.1},
    'cafe': {'x': 0.8, 'y': 0.7},
    'school': {'x': 0.5, 'y': 0.2},
    'mall': {'x': 0.2, 'y': 0.8},
...
graph = {
    ...
    'home_Anger': ['intersection_1'],
    'home_Disgust': ['intersection_1'],
    'home_Sadness': ['intersection_1'],
    'home_Fear': ['intersection_1'],
    'intersection_1': ['home_Joy', 'home_Anger', 'home_Disgust', 'home_Sadness', 'home_Fear', 'intersection_2', 'mall', 'park'],
    'intersection_2': ['intersection_1', 'school', 'cafe'],
    'park': ['intersection_1'],
    'cafe': ['intersection_2'],
    ...
    def generate_schedules(self):
        ...
        all_schedules = AllPersonasSchedule(schedules=[
            PersonaSchedule(persona='Joy', schedule=[
                ScheduleItem(time=current_time, interaction_target='park', topic='대화하기', conversation_rounds=3),
                # 다른 스케줄 항목...
            ]),
